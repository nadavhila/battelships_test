...
if (((x+1>n)||(y+1>m)||matrix[x+1][y+1].equals("–"))&&
        (x+1>n||y-1<1||matrix[x+1][y-1].equals("–"))&&
        (x-1<1||y+1>m||matrix[x-1][y+1].equals("–"))&&
        (x-1<1||y-1<1||matrix[x-1][y-1].equals("–"))&&
                 (x-1<1||matrix[x-1][y].equals("–"))&&
                 (x+1>n||matrix[x+1][y].equals("–"))&&
                 (y-1<1||matrix[x][y-1].equals("–"))&&
                  (y+1>m||matrix[x][y+1].equals("–")))
